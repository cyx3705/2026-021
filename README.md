...
Current source and formal snapshot: `4.5.0` candidate. This release rebuilds the dock manager around Vulcan Shell UI resources, adds bus-owned dock entry add/remove commands, and keeps completion metadata owned by command registrants.
